...
export default function ProductsPage() {
  ...
  async function loadProducts() {
    ...
    try {
      ...
      setProducts(unwrapCacheData(response.data));
    } catch (requestError) {
  ...
  return (
    <section className="page-block">
      <div className="panel simple-panel">
        <div className="table-header">
          <div>
            ...
            <p className="muted">
              Текущая роль: <strong>{getRoleLabel(user?.role)}</strong>
            </p>
          </div>
        ...
        <p className="muted">
          {canManageProducts
            ? "Вы можете создавать новые товары и редактировать карточки."
            : "Вам доступен только просмотр списка и карточек товаров."}
        </p>
      </div>
      ...
      <div className="panel simple-panel">
        ...
        {!canManageProducts && error ? <p className="error-banner">{error}</p> : null}
